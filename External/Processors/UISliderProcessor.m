...
- (void)processKey:(id)item value:(id)value
{
    ...
    {
        [output setObject:[OGInstruction initWithString:[value floatString]] forKey:@"maximumValue"];
    }
    else if ([item isEqualToString:@"minValue"])
    {
        [output setObject:[OGInstruction initWithString:[value floatString]] forKey:@"minimumValue"];
    }
    else if ([item isEqualToString:@"value"])
    {
        [output setObject:[OGInstruction initWithString:[value floatString]] forKey:@"value"];
    }
    else
    {
